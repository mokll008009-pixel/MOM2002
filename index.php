...
<body>
    ...
    <section class="hero">
        <div class="hero-content">
            ...
            <p>ยินดี้ต้อบรับ 037-Anime แหล่งรวมอนิเมะดุดนภาพ ทั้งแบบ ซับไทย และ พากย์ไทย อับเด็ดออนไลน์วิทีสุด! สูตร ไม่ต้องสมัครสมาชิก ไม่มโยชนารถกา รองรับทั้งมือถืออและคอมพิวเตอร์ พร้อมระบบค้นหาง่าย แฟกผมวดหมู่เตะเน ไม่
    ...
    <script>
                ...
                function renderAnimeFromLocalStorage() {
                    ...
                    if (!grid) return;
                    if (!animeList.length) {
                        grid.innerHTML = '<div style="text-align:center;color:#999;grid-column:1/-1;">ยังไม่มีข้อมูลหนัง</div>';
                        return;
                    }
